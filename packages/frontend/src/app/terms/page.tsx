          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mt-4">
                By using Agentage, you agree to these terms. If you don&apos;t agree, please
            ...
            <div className="mb-12">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-600 mb-4">
                  Agentage owns platform content. Users retain ownership of submitted content and
                  grant us license to display it.
                </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    third-party content quality. Liability limited to maximum extent permitted by
                    law.
                  </p>
                </div>
              </div>
