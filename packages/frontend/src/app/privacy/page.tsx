              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-blue-50 rounded-lg p-6">
                  ...
                  <p className="text-blue-800 mb-3">
                    We don&apos;t sell, trade, or otherwise transfer your personal information to
                    third parties. We only share data with trusted service providers, for legal
                    compliance, or when publicly submitted by you.
                  </p>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-6">
                  ...
                  <p className="text-green-800 mb-3">
                    We use encryption, secure storage, regular audits, and access controls to
                    protect your data.
                  </p>
                </div>
              </div>
